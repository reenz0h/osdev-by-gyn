; -------------------------------------------------------------
; entering long mode w/ 1GB paging 
; -------------------------------------------------------------
...
PDPT:
; preprocessor loop dance... - mapping first 512GB == 512 * 0x40000000 bytes
; 0x83 == 0x1 + 0x2 + 0x80 ---> Present/Writeablei/1GB page
; still NOT WORKING!!! (err: physical address not available)
%assign i 0
%rep 512
  dq 0x40000000*i+0x83
%assign i i+1
%endrep
