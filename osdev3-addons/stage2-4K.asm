; -------------------------------------------------------------
; entering long mode w/ 4kB paging 
; -------------------------------------------------------------
...
PDPT:
dq 1 | (1 << 1) | (PDT - $$ + 0x20000)  ; 4 KB pages
times 511 dq 0x0
...
; Level 1 TABLE - Page Table
PT:
;times 512 dq 0x3 ; TOFIX!!! wszystkie strony wskazuja na ta sama fizyczna strone 0x0!

; preprocessor loop dance... PT[i]-> 0x0003, 0x1003, 0x2003, 0x3003, ... , 0x1ff003 == first 2MB
; 0x3 == 0x1 + 0x2 ---> Present/Writeable page
%assign i 0
%rep 512
  dq 0x1000*i+0x3
%assign i i+1
